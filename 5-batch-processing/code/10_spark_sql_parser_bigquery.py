...
# specify master outside when running script, use tool spark submit

spark = SparkSession.builder \
    .appName('test') \
    .getOrCreate()

#add temporary bucket to store data before copy to Bigquery, using dataproc temporary bucket
spark.conf.set('temporaryGcsBucket', 'dataproc-temp-us-central1-946590321512-jv9dite6')
